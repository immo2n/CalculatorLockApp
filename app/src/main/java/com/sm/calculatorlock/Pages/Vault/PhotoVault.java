...
import com.sm.calculatorlock.databinding.ActivityPhotoVaultBinding;
...
public class PhotoVault extends AppCompatActivity {
    private ActivityPhotoVaultBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPhotoVaultBinding.inflate(getLayoutInflater());
        ...
        binding.selectAll.setOnClickListener(v -> {
            ...
            for (LockedFile lockedFile : dbHandler.getLockedFiles(Explorer.FileType.IMAGE)) {
            ...
            new Thread(() -> {
                ...
                runOnUiThread(() -> {
                    ...
                    binding.vaultView.setAdapter(new VaultListAdapter(
                            dbHandler.getLockedFiles(Explorer.FileType.IMAGE), this, this, fileSelectedCallback
                    ));
                    lockerUIChange();
                });
            }).start();
    ...
    private void loadFiles() {
        ...
        tabThread = new Thread(() -> {
            List<LockedFile> lockedFiles = dbHandler.getLockedFiles(Explorer.FileType.IMAGE);
            runOnUiThread(() -> {
