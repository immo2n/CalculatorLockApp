package com.sm.calculatorlock.Pages.Vault;
...
import com.sm.calculatorlock.Adapters.VaultListAdapter;
import com.sm.calculatorlock.Custom.DBHandler;
import com.sm.calculatorlock.Custom.Explorer;
import com.sm.calculatorlock.Custom.Global;
import com.sm.calculatorlock.Custom.Locker;
import com.sm.calculatorlock.DataClasses.LockedFile;
...
import com.sm.calculatorlock.databinding.ActivityAllVaultBinding;

import java.io.File;
import java.util.HashMap;
import java.util.List;

public class AllVault extends AppCompatActivity {
    private ActivityAllVaultBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAllVaultBinding.inflate(getLayoutInflater());
        ...
        binding.selectAll.setOnClickListener(v -> {
            ...
            for (LockedFile lockedFile : dbHandler.getLockedFiles(Explorer.FileType.ALL)) {
            ...
            new Thread(() -> {
                ...
                runOnUiThread(() -> {
                    ...
                    binding.vaultView.setAdapter(new VaultListAdapter(
                            dbHandler.getLockedFiles(Explorer.FileType.ALL), this, this, fileSelectedCallback
                    ));
                    lockerUIChange();
                });
            }).start();
    ...
    private void loadFiles() {
        ...
        tabThread = new Thread(() -> {
            List<LockedFile> lockedFiles = dbHandler.getLockedFiles(Explorer.FileType.ALL);
            runOnUiThread(() -> {
