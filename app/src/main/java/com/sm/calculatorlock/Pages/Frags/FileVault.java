...
import com.sm.calculatorlock.Pages.Vault.AllVault;
import com.sm.calculatorlock.Pages.Vault.PhotoVault;
import com.sm.calculatorlock.Pages.Vault.VideoVault;
import com.sm.calculatorlock.databinding.FragVaultBinding;
...
public class FileVault extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        com.sm.calculatorlock.databinding.FragVaultBinding binding = FragVaultBinding.inflate(inflater);
